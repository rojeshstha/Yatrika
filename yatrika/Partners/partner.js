...
window.addEventListener('DOMContentLoaded', function() {
  ...
  if (partnerUser) {
    ...
    if (emailInput) emailInput.value = partnerUser.email || '';
    const usernameInput = document.getElementById('username');
    if (usernameInput) usernameInput.value = partnerUser.username || '';
    const profilePic = document.getElementById('profilePic');
    if (profilePic && partnerUser.profilePic) profilePic.src = partnerUser.profilePic;
  }
});
